...
let generateShop = (dataProduct) => {
  if (dataProduct.length == 0) {
    ...
    return (allProduct.innerHTML = dataProduct
      .map((product) => {
...
let product_popup_Container = document.querySelector(
...
function showDataPopup() {
  ...
  let shop_popup_Input = document.querySelector(
    ".shop-popup-product .shop-popup-input"
  );
...
let get_input_from_Popup = document.querySelector(
  ".shop-popup-product .shop-popup-input"
);
let shop_popup_quantity_decrease = document.querySelector(
  ".shop-popup-product .shop-popup-decrease"
);
let shop_popup_quantity_increase = document.querySelector(
  ".shop-popup-product .shop-popup-increase"
);
...
let popup_add_card_Btn = document.querySelector(
  ".shop-popup-product .shop-popup-add-card"
);
...
popup_add_card_Btn.addEventListener("click", (event) => {
  ...
  if (get_input_from_Popup.value < 1) {
    ...
    let check_Id = product_Storage.find(
      (checkId) => checkId.id == get_ID_Product
    );
